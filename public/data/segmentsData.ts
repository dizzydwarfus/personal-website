      ...
      values: [
        {
          ...
          description:
            "I strive to be honest and transparent in my interactions.",
        },
        {
          name: "Curiosity",
          icon: "/images/values/curiosity.png",
          description:
            "Always eager to learn, explore new ideas, and ask questions.",
        },
        {
          name: "Continuous Learning",
          icon: "/images/values/learning.png",
          description:
            "A belief in lifelong education, both personally and professionally.",
        },
      ],
    },
  },
